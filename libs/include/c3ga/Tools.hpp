...
namespace c3ga {
    ...
    /// \return a multivector corresponding to a point p = e0 + v1 e1 + v2 e2 + v3 e3 + 0.5 || vec ||^2 einf
    template<typename T>
    c3ga::Mvec<T> randomPoint(const unsigned seed) {
        // generator
    ...
    void extractDualCircle(c3ga::Mvec<T> dualcircle, T &radius, c3ga::Mvec<T> &center, c3ga::Mvec<T> &direction) {
        ...
        radius = 0.5 * sqrt((pt2[c3ga::E1] - pt1[c3ga::E1]) * (pt2[c3ga::E1] - pt1[c3ga::E1])
                            + (pt2[c3ga::E2] - pt1[c3ga::E2]) * (pt2[c3ga::E2] - pt1[c3ga::E2])
                            + (pt2[c3ga::E3] - pt1[c3ga::E3]) * (pt2[c3ga::E3] - pt1[c3ga::E3]));
        center = point(0.5 * (pt2[c3ga::E1] + pt1[c3ga::E1]), 0.5 * (pt2[c3ga::E2] + pt1[c3ga::E2]),
                       0.5 * (pt2[c3ga::E3] + pt1[c3ga::E3]));
        direction = pt2 - pt1;
        direction[c3ga::Ei] = 0;
    ...
    void extractFlatPoint(const c3ga::Mvec<T> &flatPoint, c3ga::Mvec<T> &pt) {
        pt = -(c3ga::e0i<T>() | (c3ga::e0<T>() ^ flatPoint)) / (c3ga::e0i<T>() | flatPoint);
        ...
        if (grades_.size() == 1) {
            ...
            switch (grades_[0]) {
                ...
                case 2 : // grade 2
                {
                    ...
                    bool onlyBivectorInfinity =
                        (fabs(((mv ^ c3ga::ei<double>()) | c3ga::e0<double>()).quadraticNorm()) < epsilon);
    ...
    */
    ...
    c3ga::Mvec<T> surfaceNormal(c3ga::Mvec<T> &surface, c3ga::Mvec<T> &point) {
        ...
        normal = normal / (double) sqrt(normal[c3ga::E1] * normal[c3ga::E1] + normal[c3ga::E2] * normal[c3ga::E2]
                                        + normal[c3ga::E3] * normal[c3ga::E3]
        );
