...
namespace c3ga {
    ...
    class Mvec {
        ...
        public:
            ...
            */
            ...
            template<typename U>
            friend void traverseKVector(std::ostream &stream, const Eigen::Matrix<U, Eigen::Dynamic, 1>,
                                        unsigned int gradeMV, bool &moreThanOne);
            /// \endcond // do not comment this functions
            ...
            */
            ...
            Mvec e0() const {
                return this->extractOneComponent(1, 5, 0);
            }
            
            
            Mvec e1() const {
                return this->extractOneComponent(1, 5, 1);
            }
            
            
            Mvec e2() const {
                return this->extractOneComponent(1, 5, 2);
            }
            
            
            Mvec e3() const {
                return this->extractOneComponent(1, 5, 3);
            }
            
            
            Mvec ei() const {
                return this->extractOneComponent(1, 5, 4);
            }
            
            
            Mvec e01() const {
                return this->extractOneComponent(2, 10, 0);
            }
            
            
            Mvec e02() const {
                return this->extractOneComponent(2, 10, 1);
            }
            
            
            Mvec e03() const {
                return this->extractOneComponent(2, 10, 2);
            }
            
            
            Mvec e0i() const {
                return this->extractOneComponent(2, 10, 3);
            }
            
            
            Mvec e12() const {
                return this->extractOneComponent(2, 10, 4);
            }
            
            
            Mvec e13() const {
                return this->extractOneComponent(2, 10, 5);
            }
            
            
            Mvec e1i() const {
                return this->extractOneComponent(2, 10, 6);
            }
            
            
            Mvec e23() const {
                return this->extractOneComponent(2, 10, 7);
            }
            
            
            Mvec e2i() const {
                return this->extractOneComponent(2, 10, 8);
            }
            
            
            Mvec e3i() const {
                return this->extractOneComponent(2, 10, 9);
            }
            
            
            Mvec e012() const {
                return this->extractOneComponent(3, 10, 0);
            }
            
            
            Mvec e013() const {
                return this->extractOneComponent(3, 10, 1);
            }
            
            
            Mvec e01i() const {
                return this->extractOneComponent(3, 10, 2);
            }
            
            
            Mvec e023() const {
                return this->extractOneComponent(3, 10, 3);
            }
            
            
            Mvec e02i() const {
                return this->extractOneComponent(3, 10, 4);
            }
            
            
            Mvec e03i() const {
                return this->extractOneComponent(3, 10, 5);
            }
            
            
            Mvec e123() const {
                return this->extractOneComponent(3, 10, 6);
            }
            
            
            Mvec e12i() const {
                return this->extractOneComponent(3, 10, 7);
            }
            
            
            Mvec e13i() const {
                return this->extractOneComponent(3, 10, 8);
            }
            
            
            Mvec e23i() const {
                return this->extractOneComponent(3, 10, 9);
            }
            
            
            Mvec e0123() const {
                return this->extractOneComponent(4, 5, 0);
            }
            
            
            Mvec e012i() const {
                return this->extractOneComponent(4, 5, 1);
            }
            
            
            Mvec e013i() const {
                return this->extractOneComponent(4, 5, 2);
            }
            
            
            Mvec e023i() const {
                return this->extractOneComponent(4, 5, 3);
            }
            
            
            Mvec e123i() const {
                return this->extractOneComponent(4, 5, 4);
            }
            
            
            Mvec e0123i() const {
                return this->extractOneComponent(5, 1, 0);
            }
    ...
    template<typename T>
    Mvec<T>::Mvec(const Mvec &mv) :
            mvData(mv.mvData), gradeBitmap(mv.gradeBitmap) {
        //std::cout << "copy constructor " << std::endl;
    }
    
    
    template<typename T>
    Mvec<T>::Mvec(Mvec<T> &&multivector) :
            mvData(std::move(multivector.mvData)), gradeBitmap(multivector.gradeBitmap) {
    ...
    template<typename U, typename S>
    Mvec<U> operator>(const S &value, const Mvec<U> &mv) {
        if ((mv.gradeBitmap & 1) == 0) {
            return Mvec<U>();
        }
        else {
            return Mvec<U>(U(mv.mvData.begin()->vec.coeff(0) * value));
        }
    }
    ...
    Mvec<T> Mvec<T>::operator<(const S &value) const {
        if ((gradeBitmap & 1) == 0) {
            ...
            return Mvec<T>(T(mvData.begin()->vec.coeff(0) * value));
        }
    }
            ...
            for (const auto &itMv2 : mv2.mvData) {
                ...
                if (gradeInner != gradeOuter) {
                    ...
                    for (int gradeResult = gradeInner + 2; gradeResult < gradeMax; gradeResult += 2) {
                        ...
                        geometricFunctionsContainer<T>[gradeResult][itMv1.grade][itMv2.grade](itMv1.vec, itMv2.vec,
                                                                                              itMv3->vec
                        );
                        // check if the result is non-zero
                        if (!((itMv3->vec.array() != 0.0).any())) {
    ...
    Mvec<T> Mvec<T>::inv() const {
        ...
        if (n < std::numeric_limits<T>::epsilon() && n > -std::numeric_limits<T>::epsilon()) {
            return Mvec<T>();
        } // return 0, this is was gaviewer does.
    ...
    Mvec<T> Iinv() {
        Mvec<T> mvec;
        mvec[31] =
                pseudoScalarInverse; // we do not return just a scalar of type T because the grade should be dimension and not 0.
        return mvec;
    }
    ...
    /// \cond DEV
    template<typename U>
    void traverseKVector(std::ostream &stream, const Eigen::Matrix<U, Eigen::Dynamic, 1> kvector, unsigned int gradeMV,
                         bool &moreThanOne) {
        ...
        do {
            ...
            positionInKVector++;
        } while (std::prev_permutation(booleanXorIndex.begin(), booleanXorIndex
                .end())); // compute next permutation of the true values of booleanXorIndex
