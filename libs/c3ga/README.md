...
Garamon (Geometric Algebra Recursive and Adaptative Monster) is C++ library dedicated for c3ga Geometric Algebra.
...
## Install for Linux-Mac from the terminal
    ...
    * you can find a sample code dedicated to c3ga in the 'sample directory'
